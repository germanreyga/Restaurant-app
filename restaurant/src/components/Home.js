        ...
        <div className="card-flex">
          <Card style={{ width: '15rem', marginRight: '5rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                We encourage our customers to help the environment by giving them eco-friendly materials.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card style={{ width: '15rem', marginRight: '5rem' }}>
          ...
          <Card style={{ width: '15rem', marginRight: '5rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Our goal is to give our customers the most delicious food made with natural ingredients.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card style={{ width: '15rem' }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                Apart from our food being delicious and made with natural ingredients, it is also healthy.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
